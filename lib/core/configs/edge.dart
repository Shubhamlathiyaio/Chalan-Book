...
//       _merge(left: value.w, right: value.w, top: value.h, bottom: value.h);

//   EdgeInsets get none  => allF(0);
//   EdgeInsets get all2  => allF(2);
//   EdgeInsets get all4  => allF(4);
//   EdgeInsets get all5  => allF(5);
//   EdgeInsets get all6  => allF(6);
...
//       _merge(left: value.w, right: value.w);
...
//       _merge(top: value.h, bottom: value.h);
