class AppKeys {
  ...
  static const String newSupabaseUrl = 'https://jzhrtmwaqezmrmyoqeka.supabase.co';
  static const String newSupabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp6aHJ0bXdhcWV6bXJteW9xZWthIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQxMDMxMTEsImV4cCI6MjA2OTY3OTExMX0.yQnJtrR3XD5gtwYR_ZrZy9Ab3Td9nL2p9rINPYRFDJs';

  static const String oldSupabaseUrl = 'https://adyrowyzxxggcbblndcb.supabase.co';
  ...
  // Edge Function URLs
  static const String uploadToMegaUrl = '${newSupabaseUrl}/functions/v1/upload-to-mega';
  static const String getMegaImageUrl = '${newSupabaseUrl}/functions/v1/get-mega-image';
