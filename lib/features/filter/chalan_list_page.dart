...
class _ChalanListPageState extends State<ChalanListPage> {
            ...
            children: [
              ...
              if (hasFilters)
                Container(
                  ...
                  //   style: poppins.w500.fs10.textColor(AppColors.accent3),
                  // ),
                ),
            ],
          ),
  ...
  void _navigateToEditChalan(
    ...
    // Get the current list of chalans from the FilterBloc state
    List<Chalan> chalans = context.read<FilterBloc>().state.originalChalans;
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => AddChalanPage(
